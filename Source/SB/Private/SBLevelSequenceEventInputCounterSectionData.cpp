...
FSBLevelSequenceEventInputCounterSectionData::FSBLevelSequenceEventInputCounterSectionData() {
    ...
    this->visibleSinglePress = false;
    this->visibleDoublePress = false;
    this->visibleFlowPress = false;
    this->SingleInputKey = ESBLevelSequenceTheaterInputCounterType_GamePad_FaceButton_Left;
    this->SingleGoalInputCount = 0;
    this->SingleCustomWidgetLocation = false;
    this->SingleHitShowData = NULL;
    this->SingleDualSenseData = NULL;
    this->DoubleGoalInputCount = 0;
    this->DoubleCustomWidgetLocation = false;
}
