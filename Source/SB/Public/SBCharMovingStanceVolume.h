...
#include "SBCharMovingStanceVolume.generated.h"

class UCurveFloat;

UCLASS()
class SB_API ASBCharMovingStanceVolume : public AVolume {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere)
    AVolume* ContorlMoveSpeedInnerVolume;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere)
    bool bUseContorlMoveSpeedInnerVolume;
    ...
    ASBCharMovingStanceVolume(const FObjectInitializer& ObjectInitializer);
