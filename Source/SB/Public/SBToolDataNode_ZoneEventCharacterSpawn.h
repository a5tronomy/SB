...
#include "SBToolDataNode_ZoneEventCharacterSpawn.generated.h"
...
class SB_API USBToolDataNode_ZoneEventCharacterSpawn : public USBDataNodeBase {
    GENERATED_BODY()
public:
    ...
    USBToolDataNode_ZoneEventCharacterSpawn();
